...
const faqs = [
  {
    ...
    answer:
      'Monthly care at Burien Best Care Home ranges from roughly $5,000 to $9,500, depending on the level of care your parent needs. Memory care and full-mobility assistance sit at the higher end; lighter daily-living support sits at the lower end. We’ll provide your family a quote after our care plan conversation.',
  },
  {
        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-base md:text-lg text-ink-soft leading-relaxed mb-10">
              We’ll provide your family a quote after our care plan conversation.
            </p>
