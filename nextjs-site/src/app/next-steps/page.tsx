...
const steps = [
  {
    ...
    title: 'Meet us',
    body:
      'Weâre happy to meet wherever you feel most comfortable - a coffee shop, your loved oneâs current residence, or here at our home. When the time is right, walk through the house, meet the caregivers, and take in the backyard. Ask every question you have, even the ones you havenât thought of yet. If itâs the right fit, fantastic. If itâs not, we might have resources to share that would suit your needs better.',
    duration: '60â90 min',
  },
  {
    n: '02',
  ...
  },
  {
    ...
    body:
      'We help you think through what to bring, how to talk to your parent about the transition, and what the first week might look like. If you need a hand with the move itself, we can pack, move your loved one in, unpack, and get them settled. We’ll even paint an accent wall in their bedroom in a color they choose. Weâll also coordinate with their current doctor, pharmacy, case manager, and social worker to make sure everything is set up before their arrival. We handle the logistics so you can focus on your family.',
    duration: '1â2 weeks of prep',
  },
  {
    n: '04',
    title: 'Settle in and stay connected',
    body:
      'First days matter, so we go slow, introduce routines gently, and check in with you often. Youâre welcome any time. For Sunday dinner, birthdays, or just because. If you plan to share a meal with us, weâll need to know in advance so we can plan appropriately. Your parent is home. You stay involved as much as you want to be.',
...
const faqs = [
  {
    ...
    answer:
      'Monthly care at Burien Best Care Home ranges from roughly $5,000 to $9,500, depending on the level of care your parent needs. Memory care and full-mobility assistance sit at the higher end; lighter daily-living support sits at the lower end. Weâll provide your family a quote after our care plan conversation, once we understand your loved oneâs current care requirements and needs.',
  },
  {
    question: 'Does Medicaid or long-term care insurance cover this?',
    answer:
      'We accept private pay, long-term care insurance, Medicaid, and some VA benefits. If you have LTC insurance, weâll help you work through the claim process with your carrier.',
  },
  {
    question: 'How fast can my parent move in?',
    answer:
      'When we have an open room, the timeline from first visit to move-in is usually 1â3 weeks, long enough to build a real care plan, coordinate medical records, and avoid rushing them through the transition. If youâre in a hospital-discharge situation, we can often accelerate that to a matter of days. In urgent cases we can do a same-day move-in, though that isnât our preference.',
  },
  {
    question: 'What if my parentâs needs change over time?',
    answer:
      'We expect care needs to change over time. Thatâs what an adult family home is built for. As your parentâs needs evolve, we adjust the care plan with them. More help with bathing one month, a new medication the next, hospice support if and when that day comes. You wonât be forced to move them to a different facility when things change.',
  },
  {
  ...
  {
    question: 'What happens if it isnât the right fit?',
    answer:
      'If you or we feel that another setting would serve your loved one better, letâs talk about it. If thereâs something we can adjust, letâs try that first. But if a move is the right decision, weâll make it together. No one benefits from forcing a fit that isnât right.',
  },
]
        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-base md:text-lg text-ink-soft leading-relaxed mb-10">
              Weâll provide your family a quote after our care plan conversation, once we understand your loved oneâs current care requirements and needs.
            </p>
