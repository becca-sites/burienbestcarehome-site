...
export const metadata: Metadata = {
  title: 'Is It Time for Senior Care? Free Assessment',
  description:
    'A free, compassionate assessment to help families decide if it is time to place a parent or spouse in care, and what kind of care is the right fit. No pressure, no sales pitch. Takes 3 minutes.',
  keywords: [
  ...
  openGraph: {
    title: 'Is It Time for Senior Care? Free Assessment',
    description:
      'A free, compassionate assessment to help families decide if it is time to place a parent or spouse in care. No pressure, no sales pitch.',
    url: 'https://burienbestcarehome.com/assessment',
    type: 'website',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Is It Time for Senior Care? Free Assessment | Burien Best Care Home',
    description:
      'A free, compassionate assessment to help families decide if it is time to place a parent or spouse in care.',
  },
}
...
const faqItems = [
  ...
  {
    question: 'How long does this assessment take?',
    answer:
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Free Care Assessment',
                item: 'https://burienbestcarehome.com/assessment',
              },
            ],
          }),
        }}
